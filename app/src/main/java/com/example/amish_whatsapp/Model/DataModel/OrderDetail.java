...
public class OrderDetail {
    ...
    public String getMarking_status() {
        return marking_status;
    }

    public void setMarking_status(String marking_status) {
        this.marking_status = marking_status;
    }
    ...
    public void setReturnable_count(String returnable_count) {
        this.returnable_count = returnable_count;
    }
}
